...
best_model = models.get('yolo_nas_l',
                        ...
                        checkpoint_path="checkpoints/warehouse-model-1/ckpt_best.pth")
...
for confidence_threshold in confidence_thresholds:
    ...
    print(result)
    f1_scores.append(result['F1@0.50'])
    map_scores.append(result['mAP@0.50'])
    recall_scores.append(result['Recall@0.50'])
    precision_scores.append(result['Precision@0.50'])
